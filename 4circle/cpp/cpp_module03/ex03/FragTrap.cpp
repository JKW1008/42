...
FragTrap::FragTrap() : ClapTrap("Default FragTrap")
{
	...
	setEnergyPoints(100);
	setAttackDamage(30);
	std::cout << "FragTrap default attack damage check " << this->getAttackDamage() << std::endl;
...
FragTrap::FragTrap(const std::string& name) : ClapTrap(name)
{
	...
	setEnergyPoints(100);
	setAttackDamage(30);
	std::cout << "FragTrap name attack damage check " << this->getAttackDamage() << std::endl;
	std::cout << "Name FragTrap " << name << " created"  << std::endl;
}

FragTrap::FragTrap(const FragTrap& other) : ClapTrap(other)
{
	std::cout << "FragTrap copy default attack damage check " << this->getAttackDamage() << std::endl;
...
FragTrap& FragTrap::operator=(const FragTrap& other)
{
	...
	std::cout << "FragTrap operator default attack damage check " << this->getAttackDamage() << std::endl;
